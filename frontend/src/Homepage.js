        ...
        >
            ...
            <VStack>
                <Heading
                    ...
                    mb="6"
                    bgGradient="linear(to-r, maryland.red, maryland.yellow)"
                    bgClip="text"
                    textAlign="center"
                >
                    Terrapin Course Search
                </Heading>
            ...
            <Box>
                <Text textAlign="center" fontSize="sm" pb={4} pt={10}>
                    {'Built by '}
                    <Link href="https://www.linkedin.com/in/kitopang/" isExternal color="red.400">
                        Kito Pang
                    </Link>
                    {' and '}
                    <Link href="https://www.linkedin.com/in/rohan77/" isExternal color="red.400">
                        Rohan Sharma
                    </Link>
                </Text>
            </Box>
